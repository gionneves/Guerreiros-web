...
$sql = 'INSERT INTO os_tablet (cliente, marca, modelo, EMEI, defeitos, cliente_adicional, data_retirada, hora_retirada) VALUES (:CLIENTE, :MARCA, :MODELO, :EMEI, :DEFEITOS, :CLIENTE_ADICIONAL, :DATA_RETIRADA, :HORA_RETIRADA)';
