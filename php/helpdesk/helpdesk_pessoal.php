...
$stmt = $pdo->prepare("INSERT INTO ordem_servicos (cliente, servico, data_servico, hora_servico, tipo_servico) VALUES (:cliente, :servico, :data_servico, :hora_servido, :tipo_servico,)");
