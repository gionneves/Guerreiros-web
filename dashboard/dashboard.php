    ...
    <nav>
        <ul class="nav nav-tabs nav-fill bg-white">
            ...
            <li class="nav-item" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                <a class="nav-link" aria-current="page" href="View_os.php">Minhas O.S.</a>
            </li>
        </ul>
    </nav>
    <!-- Final da NAV -->
            ...
            <div class="row">
                ...
                <div class="col-sm m-2" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                    <a href="/views/celular.html">
                        <img src="/images/os_celular.png" alt="O.S. Celular" width="175em" height="105em" />
                    </a>
                ...
                <div class="col-sm m-2" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                    <a href="/views/videogame.html">
                        <img src="/images/os_videogame.png" alt="O.S. Videogame" width="175em" height="105em" />
                    </a>
                ...
                <div class="col-sm m-2" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                    <a href="/views/tablet.html">
                        <img src="/images/os_tablet.png" alt="O.S. Tablet" width="175em" height="105em" />
                    </a>
